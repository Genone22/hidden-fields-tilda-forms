...
function eduregion_sc(cl, pu) {
    ...
    document.cookie = "cl_uid=" + cl + ";" + "expires=" + d.toUTCString() + ";path=/; domain=domen.ru"; // Установка куки "cl_uid" с заданным значением и сроком действия на домене "eduregion.ru".

    document.cookie = "publ_uid=" + pu + ";" + "expires=" + d.toUTCString() + ";path=/; domain=domen.ru"; // Установка куки "publ_uid" с заданным значением и сроком действия на домене "eduregion.ru".
